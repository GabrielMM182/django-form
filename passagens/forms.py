...
from passagens.validation import campo_tem_algum_numero, data_ida_maior_que_data_volta, data_ida_menor_data_de_hoje, origem_destino_iguais
...
class PassagemForms(forms.Form):
    ...
    def clean(self):
        origem = self.cleaned_data.get('origem') # se ocorrer algum erro no origem ou destino vai retornar None por isso o do self.cleaned_data.get
